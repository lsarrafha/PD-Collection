...
def plot_volcano(dataframe, title):
    display(Markdown('**Volcano Plot** <br> We can also display the limma-analyzed results using a Volcano plot, in which the logFC values are on the x-axis and the log-transformed adjusted p-values on the y-axis.'))
